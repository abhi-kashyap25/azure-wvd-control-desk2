 ...
 */
function updateAGalleryInVMAccessControlProfile() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] || "myResourceGroup";
        const galleryName = "myGalleryName";
        const inVMAccessControlProfileName = "myInVMAccessControlProfileName";
        const galleryInVMAccessControlProfile = { properties: { applicableHostEndpoint: "WireServer", osType: "Linux" } };
        const credential = new DefaultAzureCredential();
        const client = new ComputeManagementClient(credential, subscriptionId);
        const result = yield client.galleryInVMAccessControlProfiles.beginUpdateAndWait(resourceGroupName, galleryName, inVMAccessControlProfileName, galleryInVMAccessControlProfile);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=galleryInVMAccessControlProfilesUpdateSample.js.map