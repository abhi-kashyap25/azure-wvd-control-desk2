...
export declare interface AppAttachPackage extends TrackedResource {
 ...
 * **ALL**
 */
export declare type AppAttachPackageArchitectures = string;

/** Optional parameters. */
export declare interface AppAttachPackageCreateOrUpdateOptionalParams extends coreClient.OperationOptions {
}

/** Contains response data for the createOrUpdate operation. */
export declare type AppAttachPackageCreateOrUpdateResponse = AppAttachPackage;

/** Optional parameters. */
export declare interface AppAttachPackageDeleteOptionalParams extends coreClient.OperationOptions {
}

/** Optional parameters. */
export declare interface AppAttachPackageGetOptionalParams extends coreClient.OperationOptions {
}

/** Contains response data for the get operation. */
export declare type AppAttachPackageGetResponse = AppAttachPackage;

/** Interface representing a AppAttachPackageInfo. */
export declare interface AppAttachPackageInfo {
    /**
...
/** Optional parameters. */
export declare interface AppAttachPackageInfoImportNextOptionalParams extends coreClient.OperationOptions {
}

/** Contains response data for the importNext operation. */
export declare type AppAttachPackageInfoImportNextResponse = AppAttachPackageList;

/** Optional parameters. */
export declare interface AppAttachPackageInfoImportOptionalParams extends coreClient.OperationOptions {
}

/** Contains response data for the import operation. */
export declare type AppAttachPackageInfoImportResponse = AppAttachPackageList;

/** Schema for Import Package Information properties. */
export declare interface AppAttachPackageInfoProperties {
...
export declare interface AppAttachPackageList {
    /** List of App Attach Package definitions. */
...
/** Optional parameters. */
export declare interface AppAttachPackageListByResourceGroupNextOptionalParams extends coreClient.OperationOptions {
}

/** Contains response data for the listByResourceGroupNext operation. */
export declare type AppAttachPackageListByResourceGroupNextResponse = AppAttachPackageList;

/** Optional parameters. */
export declare interface AppAttachPackageListByResourceGroupOptionalParams extends coreClient.OperationOptions {
    /** OData filter expression. Valid properties for filtering are package name and host pool. */
    filter?: string;
}

/** Contains response data for the listByResourceGroup operation. */
export declare type AppAttachPackageListByResourceGroupResponse = AppAttachPackageList;

/** Optional parameters. */
export declare interface AppAttachPackageListBySubscriptionNextOptionalParams extends coreClient.OperationOptions {
}

/** Contains response data for the listBySubscriptionNext operation. */
export declare type AppAttachPackageListBySubscriptionNextResponse = AppAttachPackageList;

/** Optional parameters. */
export declare interface AppAttachPackageListBySubscriptionOptionalParams extends coreClient.OperationOptions {
    /** OData filter expression. Valid properties for filtering are package name, host pool, and resource group. */
    filter?: string;
}

/** Contains response data for the listBySubscription operation. */
export declare type AppAttachPackageListBySubscriptionResponse = AppAttachPackageList;

/** Interface representing a AppAttachPackageOperations. */
export declare interface AppAttachPackageOperations {
    /**
...
export declare interface AppAttachPackagePatch extends Resource {
    /** Detailed properties for App Attach Package */
    properties?: AppAttachPackagePatchProperties;
}

/** Schema for patchable fields on an App Attach Package. */
export declare interface AppAttachPackagePatchProperties {
    /** Detailed properties for App Attach Package */
...
/** Schema for App Attach Package properties. */
export declare interface AppAttachPackageProperties {
    /**
...
/** Optional parameters. */
export declare interface AppAttachPackageUpdateOptionalParams extends coreClient.OperationOptions {
    /** Object containing App Attach Package definition. */
    appAttachPackagePatch?: AppAttachPackagePatch;
}

/** Contains response data for the update operation. */
export declare type AppAttachPackageUpdateResponse = AppAttachPackage;
 ...
 * **DoNotFail**
 */
export declare type FailHealthCheckOnStagingFailure = string;
...
/** Optional parameters. */
export declare interface HostPoolsListRegistrationTokensOptionalParams extends coreClient.OperationOptions {
}

/** Contains response data for the listRegistrationTokens operation. */
export declare type HostPoolsListRegistrationTokensResponse = RegistrationTokenList;
...
export declare interface ImportPackageInfoRequest {
    /** URI to Image */
    path?: string;
...
export declare enum KnownAppAttachPackageArchitectures {
    /** ARM */
    ARM = "ARM",
    /** ARM64 */
    ARM64 = "ARM64",
...
export declare enum KnownFailHealthCheckOnStagingFailure {
    /** Unhealthy */
    Unhealthy = "Unhealthy",
    /** NeedsAssistance */
...
export declare enum KnownPackageTimestamped {
    /** Timestamped */
 ...
 * **NotTimestamped**
 */
export declare type PackageTimestamped = string;
...
export declare interface RegistrationTokenList {
    /** List of RegistrationToken definitions. */
...
export declare interface RegistrationTokenMinimal {
    /** Expiration time of registration token. */
    expirationTime?: Date;
    /** The registration token base64 encoded string. */
    token?: string;
