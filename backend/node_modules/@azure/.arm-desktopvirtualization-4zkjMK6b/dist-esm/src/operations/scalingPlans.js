...
export class ScalingPlansImpl {
    ...
    listByHostPoolPagingAll(resourceGroupName, hostPoolName, options) {
        return __asyncGenerator(this, arguments, function* listByHostPoolPagingAll_1() {
            var _a, e_3, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByHostPoolPagingPage(resourceGroupName, hostPoolName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
    ...
    create(resourceGroupName, scalingPlanName, scalingPlan, options) {
        return this.client.sendOperationRequest({ resourceGroupName, scalingPlanName, scalingPlan, options }, createOperationSpec);
    }
    /**
...
//# sourceMappingURL=scalingPlans.js.map