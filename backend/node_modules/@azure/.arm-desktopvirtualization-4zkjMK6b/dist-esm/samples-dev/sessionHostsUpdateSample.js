...
function sessionHostUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.sessionHosts.update(resourceGroupName, hostPoolName, sessionHostName, options);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=sessionHostsUpdateSample.js.map