 ...
 */
function scalingPlanPooledSchedulesUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.scalingPlanPooledSchedules.update(resourceGroupName, scalingPlanName, scalingPlanScheduleName, options);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=scalingPlanPooledSchedulesUpdateSample.js.map