...
function sessionHostDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.sessionHosts.delete(resourceGroupName, hostPoolName, sessionHostName, options);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=sessionHostsDeleteSample.js.map